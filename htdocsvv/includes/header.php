...
// Note: On ne redirige plus si pas connecté pour permettre l'accès visiteur
...
<body>
    ...
    <div class="global-header">
        <div class="header-content">
            <div class="logo">
                <h1><a href="store.php"><span style="color:#fff;">S</span>TIM</a></h1>
            </div>
            <div class="nav-links">
            ...
            <div class="user-panel" style="display:flex; align-items:center; gap:10px;">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <div style="text-align:right;">
                        ...
                        |
                        <a href="login.php?logout=true">déco</a>
                        <br>
                ...
                <?php
                    ...
                    <a href="login.php" class="btn-header-login">Connexion</a>
                    <a href="register.php" class="btn-header-register">Inscription</a>
                <?php
endif; ?>
            </div>
        </div>
        
        <?php if (isset($_SESSION['username']) && $_SESSION['username'] === 'admin_community'): ?>
        <div style="background: linear-gradient(90deg, #ff9f43, #ee5253); color: white; text-align: center; padding: 10px; font-weight: bold; letter-spacing: 1px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
            ⚠️ ALERT: ADMINISTRATOR SESSION ACTIVE <br>
            Secret Key: <code style="background: rgba(0,0,0,0.3); padding: 2px 8px; border-radius: 4px;">STEAM{XSS_C00K13_ST34L3R}</code>
        </div>
        <?php
endif; ?>
    </div>
